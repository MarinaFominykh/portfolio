export const initialProjects = [{
    ...
    },
    {
        ...
        description: "Developed and deployed an Express API to support the front-end of the Mafia rating web application. Routes support query parameters and authorization using JWT. Includes endpoints for games, players, registration, login",
        url: "https://mafia-raiting.ru/",
    ...
    },
    {
        ...
        description: "Full-stack application. The frontend is an interactive page for displaying cards with photos. Authorized users can add photos, delete them, and give likes. Вackend – Express API. Routes support query parameters and authorization using JWT. Includes endpoints for cards, registration, login and profile. ",
    ...
    },
    {
        ...
        description: "This is an application designed to assign roles in the Mafia game. It is created to assist organizers and game masters in quickly assigning roles for any number of players in any game layout. Upon loading, 10 cards with role names and 10 cards with player nicknames (users can specify real player names or use pre-set fake ones) are displayed. Clicking on the button assigns a random role to each player. Users can modify role names, add new roles, or delete unnecessary ones.The application has an adaptive design and can be displayed correctly on any device, including mobile phones and tablets.",
    ...
    },
    {
        ...
        description: "A Telegram chatbot for interacting with the OpenAI API. The bot supports both text and voice messages.",
...

    {
        ...
        description: "A single-page website about traveling in Russia. The application has an adaptive design and can be displayed correctly on any device, including mobile phones and tablets.",
